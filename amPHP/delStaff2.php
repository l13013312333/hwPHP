...
$sql = "SELECT * FROM staff WHERE id_number Like '%$id%'";
...
<table id="mytable" cellspacing="0">
  <tr>
	...
	<th scope="col" abbr="Dual 2">刪除</th>
  </tr>
	...
	if(count($user)==0){
		...
		foreach($user AS $item){
			if($count==0){
				...
				echo "<td> <input type='button' onclick='javascript:location.href=\"doDelete.php?id=". $item['id_number']."\"' value='刪除'></input></td>";
				echo "</tr>";
				$count = 1;
			}
			else{
