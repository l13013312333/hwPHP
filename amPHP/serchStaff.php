...
$sql = "SELECT * FROM checklist WHERE id_number Like '%%'";
...
html>body td {
    font-size:11px;} 
		...
		border-radius: 5px; }
.Outerbox { width:450px; margin:0px auto; overflow:auto; height:auto; z-index:10; }
</style>
...
<div class="Outerbox"><div class="Outerbox" style="position: fixed; top:10px; right:10px;">
┻┳I I'm just ....<br>
┳┻|<br>
┻┳I<br>
┳┻|        <br>
